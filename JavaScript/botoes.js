// Modern JavaScript for Ações Transformadoras - Botões //
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const languageButtons = {
        '.pt-br': () => {
            showAlert("Você já está utilizando esta linguagem.");
        },
        '.maislang': () => {
            showAlert("Para visualizar esta página em outras línguas, basta ativar a extensão do Google Tradutor em seu navegador.");
        }
    };
    ...
    const themeButtons = {
        '.tema': () => {
            showAlert("Você já está utilizando este tema.");
        }
    };
